...
CREATE INDEX Index7ec38454875ea9868e819818f59288f11898149c on Посылка (Транзакция); 
 ...
 ALTER TABLE Посылка ADD CONSTRAINT FKa768147d5c3b749b3aee4176dcf81d92e6436d47 FOREIGN KEY (Ячейка) REFERENCES Ячейка; 
CREATE INDEX Indexa768147d5c3b749b3aee4176dcf81d92e6436d47 on Посылка (Ячейка); 
