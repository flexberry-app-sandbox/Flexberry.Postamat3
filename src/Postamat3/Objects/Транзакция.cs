...
namespace IIS.Postamat3
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat3.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.Postamat3.Пользователь fПользователь;
        ...
        public virtual IIS.Postamat3.Оплата Оплата
        {
            get
            {
                ...
                IIS.Postamat3.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.Postamat3.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.Postamat3.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.Postamat3.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.Postamat3.Транзакция));
                }
            }
        }
    }
