...
namespace IIS.Postamat3
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat3.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat3.DetailArrayOfЯчейка fЯчейка;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat3.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat3.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat3.DetailArrayOfЯчейка Ячейка
        {
            get
            {
                ...
                {
                    this.fЯчейка = new IIS.Postamat3.DetailArrayOfЯчейка(this);
                }
                IIS.Postamat3.DetailArrayOfЯчейка result = this.fЯчейка;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat3.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat3.Постамат));
                }
            }
        }
    }
