...
namespace IIS.Postamat3
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat3.Состояние fСостояние;
        ...
        public virtual IIS.Postamat3.Состояние Состояние
        {
            get
            {
                ...
                IIS.Postamat3.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Postamat3.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.Postamat3.Логистика));
                }
            }
        }
    }
